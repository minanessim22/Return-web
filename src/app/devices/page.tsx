...
export default function DevicesRedirectPage() {
  ...
  useEffect(() => {
    ...
    router.replace(`${base}?tab=devices`);
  }, [router]);
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-[#014CB3] to-[#60C10F] text-white text-center px-6">
      <div>
        <h1 className="text-3xl font-black mb-3">Opening devices</h1>
        <p className="text-white/80">Redirecting to your connected devices and identification tools…</p>
      </div>
    </div>
  );
}
